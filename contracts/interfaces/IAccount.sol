...
interface IAccount {
    ...
    function createLimitOrder(address adapter, IExchange.PositionOrder calldata order) external;
    function createTriggerOrder(address adapter, IExchange.PositionOrder calldata order) external;
