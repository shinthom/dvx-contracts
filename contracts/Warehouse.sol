...
contract Warehouse is IWarehouse, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function createLimitOrder(IExchange.LimitOrder calldata limitOrder) override public returns (uint256) {
    ...
    function createTriggerOrder(IExchange.TriggerOrder calldata triggerOrder) override public returns (uint256) {
